...
const Hero = () => {
  ...
  return (
    <section
      className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden text-center pt-24 sm:pt-28"
    ...
    >
      ...
      <div className="relative z-30 px-6 sm:px-10 max-w-5xl mt-10">
        ...
        {/* 🐄 Cow & Ethanol Images Section */}
        <div className="flex justify-center items-center flex-wrap gap-6 sm:gap-12 mb-12">
          <motion.img
            src="/Images/CowFertilizer.jpg"
            alt="Cow Fertilizer"
            className="w-40 sm:w-52 md:w-60 rounded-2xl shadow-lg hover:scale-105 transition-transform duration-300"
            whileHover={{ y: -10 }}
