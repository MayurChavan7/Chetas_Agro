  ...
  return (
    <section className="relative overflow-hidden py-24 md:py-40 bg-gradient-to-b from-green-100 to-green-50">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
          At <span className="font-semibold text-green-800">Chetas Agrotech</span>, we engineer{" "}
          <span className="text-green-700 font-semibold">organic fertilizers</span> and{" "}
          <span className="text-yellow-600 font-semibold">renewable ethanol</span> — advancing
          agriculture and clean energy for a sustainable tomorrow.
        </p>
      </motion.div>
    </section>
  );
...
const InfoSection = ({
  ...
  <section className="mt-28 md:mt-36 px-6 relative">
    ...
    <motion.div
      ...
      viewport={{ once: true }}
    >
      <img src={image1} alt={title} className="w-full object-cover max-h-[500px]" loading="lazy" />
    </motion.div>
...
// ✅ Updated Sustainability & Impact Section
const StatsSection = () => (
  <section className="mt-32 bg-gradient-to-r from-green-700 to-green-600 py-20 text-white relative overflow-hidden">
    <div className="absolute inset-0 opacity-10 bg-[url('/Images/pattern-leaf.svg')] bg-repeat" />
    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 max-w-5xl mx-auto px-6 text-center relative z-10">
      {[
        { number: "75,000+", label: "Cattle Managed" },
        { number: "100%", label: "Organic Certified" },
...
const CTASection = () => (
  <section className="text-center py-24 px-6 bg-gradient-to-r from-green-800 to-green-600 rounded-3xl text-white shadow-2xl max-w-5xl mx-auto mt-32">
    <h3 className="text-4xl font-extrabold mb-6">Grow With Us 🌾</h3>
    <p className="text-lg md:text-xl mb-10 max-w-xl mx-auto leading-relaxed">
      Join <strong>Chetas Agrotech</strong> — advancing agriculture and renewable energy for a
