    ...
    <section className="relative py-24 px-6 bg-gradient-to-br from-green-50 via-white to-green-100 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto text-center">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          {reviews.map(({ name, country, review, photo, rating }, i) => (
            <motion.div
              key={i}
              className="bg-white p-8 rounded-3xl shadow-xl flex flex-col items-center text-center max-w-md mx-auto hover:scale-105 transition-transform duration-300"
